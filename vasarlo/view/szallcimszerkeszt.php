<?php
include '..\controller\szallcimszerkeszt.php';
...
echo'<form action="../controller/szallcimszerkeszt.php" method="post">';
...
echo "<tr><th>számlázási cím</th><th>adószám</th><th>első</th><th></th><th></th></tr>";
 ...
 echo '<tr><td><input type="text" id="szallcim" name="szallcim" value=" '.$stand->szallcim.'"></td>';
